...
const argv = require('yargs')
  ...
  .option('fields', { type: 'array', default: ['EventClass', 'TextData', 'QueryHash', 'HostName', 'ClientProcessID', 'LoginName', 'SPID', 'Duration', 'StartTime', 'EndTime', 'Reads', 'Writes', 'CPU', 'ServerName', 'DatabaseName', 'RowCounts'], describe: 'Fields to include.' })
